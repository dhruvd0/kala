...
class Art extends Equatable {
  ...
  factory Art.fromJson(String source) => Art.fromMap(json.decode(source));
  ...
  factory Art.fromMap(Map<String, dynamic> map) {
    return Art(
      ...
      viewMode: (map['viewMode']) ?? ArtViewMode.scroll,
    );
  }
